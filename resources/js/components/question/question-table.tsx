        ...
        <div className="space-y-4">
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h4 className="text-sm sm:text-base font-extrabold tracking-tight text-slate-900 dark:text-white">
                            {t('test_show.questions') || 'Savollar'}
                        </h4>
                    </div>
            ...
            {part.questions?.length === 0 && (
                <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 py-12 dark:border-slate-800">
                    ...
                    <p className="text-xs sm:text-sm font-medium text-slate-500 dark:text-slate-400">{t('test_show.no_questions_yet') || 'Hozircha savollar qo\'shilmagan'}</p>
                </div>
            )}
        </div>
    );
