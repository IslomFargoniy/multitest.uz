                ...
                return (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="flex w-full items-center justify-between px-3 py-3 sm:px-6 sm:py-5 text-left focus:outline-none"
                        >
                            <div className="flex items-center gap-2.5 sm:gap-4">
                                <div
                                    className={`flex h-8 w-8 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-xl font-mono text-xs sm:text-sm font-black transition-colors ${
                                        isOpen
                                ...
                                <div className="min-w-0">
                                    <h3
                                        className={`text-sm sm:text-lg font-bold truncate transition-colors ${
                                    ...
                                    {!isOpen && item.description && (
                                        <p className="line-clamp-1 text-[11px] sm:text-xs font-medium text-slate-400 mt-0.5">{item.description}</p>
                                    )}
                                </div>
                            </div>
                            <ChevronDown
                                className={`h-4 w-4 sm:h-5 sm:w-5 shrink-0 text-slate-400 transition-transform duration-300 ${isOpen ? 'rotate-180 text-indigo-600 dark:text-indigo-400' : ''}`}
                            />
                        </button>
                        ...
                        >
                            <div className="overflow-hidden">
                                <div className="space-y-4 px-2.5 pt-0 pb-4 sm:px-6 sm:pb-8">
                                    <div className="grid grid-cols-1 gap-3 sm:gap-6 lg:grid-cols-2">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="rounded-xl sm:rounded-2xl border border-slate-100 bg-slate-50/70 p-3 sm:p-4 text-xs sm:text-sm leading-relaxed text-slate-700 dark:border-slate-800/60 dark:bg-slate-950/40 dark:text-slate-300">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            {item.audio_path ? (
                                                <div className="flex h-[48px] sm:h-[52px] items-center rounded-xl sm:rounded-2xl border border-indigo-100 bg-indigo-50/40 px-2.5 dark:border-indigo-900/30 dark:bg-indigo-950/20">
                                                    <audio preload="none" controls className="h-8 w-full">
                                                        <source src={item.audio_path} />
                                                    </audio>
                                                </div>
                                            ) : (
                                                <div className="flex h-[48px] sm:h-[52px] items-center justify-center rounded-xl sm:rounded-2xl border border-dashed border-slate-200 text-xs font-medium text-slate-400 dark:border-slate-800">
